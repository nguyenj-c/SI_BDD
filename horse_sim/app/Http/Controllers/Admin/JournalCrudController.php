...
class JournalCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Journal::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/journal');
        CRUD::setEntityNameStrings('journal', 'journals');
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('ID_article');
        CRUD::column('date');
        CRUD::column('agenda');
        CRUD::column('top_events');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('ID_article');
        CRUD::field('date');
        CRUD::field('agenda');
        CRUD::field('top_events');
